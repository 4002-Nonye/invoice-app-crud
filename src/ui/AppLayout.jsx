...
function AppLayout() {
  ...
  return (
    <>
      <form
        className="fixed z-40 flex h-full flex-col space-y-4 overflow-scroll rounded-lg bg-white-200 px-5 pb-16 pt-32 shadow-lg lg:pl-36 lg:pr-10 lg:pt-16 xl:w-[54.5%] dark:bg-darkblue-500"
        action=""
      >
        ...
        <ItemList />
        {/* CTAs */}
        <div className="flex  flex-col-reverse md:flex-row justify-center gap-4 pt-16 md:justify-between md:gap-7">
      ...
      <SideBar />
      <div className="fixed bottom-0 left-0 right-0 top-0 z-20 h-screen bg-black bg-opacity-20 backdrop-blur"></div>
