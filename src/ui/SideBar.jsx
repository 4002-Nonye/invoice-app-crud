...
function SideBar() {
  return (
    <div className="fixed left-0 top-0 flex h-20 w-full items-center justify-between bg-darkblue-200 lg:h-screen lg:w-[unset] lg:flex-col lg:rounded-br-3xl lg:rounded-tr-3xl">
