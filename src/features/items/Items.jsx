    ...
    <div className="relative flex flex-col justify-between md:pb-0 pb-3 font-bold md:flex-row">
      ...
      <div className="mb-7 inline-flex items-center gap-6 md:mb-0">
        ...
        <div className="flex flex-col">
          ...
          <p className="m-auto w-20 p-3 text-grey-100 dark:text-white-100 md:p-0">
            {item.qty * item.price}
          </p>
        </div>
        ...
        <div className="absolute right-0 text-center">
          ...
          >
            <path
              ...
              className="fill-grey-200 hover:fill-red-200 cursor-pointer transition-all duration-500"
            />
          </svg>
        </div>
      </div>
