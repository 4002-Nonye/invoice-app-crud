...
function InvoiceItem({ invoice }) {
  return (
    <Link
      ...
      className="mt-6 flex cursor-pointer md:items-center justify-between rounded-md border-2 bg-white-200 p-3 md:p-6 shadow-sm hover:border-2 dark:bg-darkblue-300 hover:border-lightblue-300 dark:border-darkblue-300"
    >
      <div className="flex flex-col md:items-center  md:flex-row md:gap-10">
        ...
        <p className="text-sm text-lightblue-100 dark:text-white-200">{invoice.startDate}</p>
      ...
      <div className="flex flex-col items-end md:items-center gap-5 md:flex-row md:gap-10">
        ...
        <p className="text-sm dark:text-white-200 text-lightblue-100 md:hidden">{invoice.clientName}</p>
        <p
